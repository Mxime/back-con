  ...
  !(function (e, t) {
    ...
    if (r.invoked)
      ...
      (c.type = "text/javascript"),
        (c.integrity =
          "sha384-r58GovPc8jo7o9PFd/Y8xHwOiockvJvuIBZZqsA7I8EzliMj0Pe0Sbx7Ti2ClxDD"),
        (c.crossOrigin = "anonymous"),
        (c.async = !0),
        (c.src =
          "https://cdn.amplitude.com/libs/analytics-browser-2.8.0-min.js.gz"),
        (c.onload = function () {
...
amplitude.init("ae5d95d940fe7924673b6a227afc0fce", { serverZone: "EU" });

if (window.location.origin.includes("github.io")) {
  amplitude.track("BackCon Page Viewed", {
